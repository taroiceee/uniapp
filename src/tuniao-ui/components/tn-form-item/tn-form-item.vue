    ...
    >
      ...
      >
        ...
        <view
          ...
          class="tn-form-item--left__content"
        ...
        >
          ...
          <view class="tn-form-item--left__content__label" :style="[elLabelStyle]">
            {{ label }}
          </view>
  ...
  computed: {
    ...
    elLabelStyle() {
      return Object.keys(this.labelStyle).length
        ? this.labelStyle
        : Object.keys(this.parentData.labelStyle).length
