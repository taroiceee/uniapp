<template>
  <view :style="{ paddingTop: vuex_custom_bar_height + 'px' }">
    <tn-nav-bar>章节列表</tn-nav-bar>
    <view class="page_novel_chapters_table page_diy_table" id="page_diy_table">
      <!-- 筛选模块(开始) -->
      <view class="search-wrap">
		...
		<view class="toolbar">
		  <view
		    ...
		    @click="
		      $navTo(
		        '/pagesA/novel_chapters/view?novel_reading_id=' +
		          query.novel_reading_id +
		          '&source_table=' +
		          query.source_table +
		          '&source_field=' +
		          query.source_field
        ...
        <view v-for="(o, i) in list" :key="i" class="list-item">
          ...
          <view class="operate-bar">
            ...
            <view
              width="100%"
              @click="
                $navTo('/pagesA/novel_chapters/view?novel_chapters_id=' + o['novel_chapters_id'])
              "
