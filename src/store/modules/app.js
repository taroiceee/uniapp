...
let saveStateKeys = ['token', 'userInfo', 'userGroup', 'userAuth', 'supportChat'];
...
export default {
  ...
  state() {
    return {
      ...
      vuex_safe_area_bottom: 0,
      pathList: {
        '/exam/list': '/pagesA',
        '/evaluation/list': '/pagesA',
        '/chat/index': '/pagesB',
        '/goods/list': '/pagesA',
        '/message/list': '/pagesB',
      ...
      userGroup: lifeData.userGroup ? lifeData.userGroup : '游客',
      userAuth: lifeData.userAuth ? lifeData.userAuth : [],
      supportChat: lifeData.supportChat ? lifeData.supportChat : undefined,
      // currentChatObj: lifeData.currentChatObj ? lifeData.currentChatObj : undefined,
    };
  },
  mutations: {
    setUniVuex(state, payload) {
